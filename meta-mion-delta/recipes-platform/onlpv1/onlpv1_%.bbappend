...
SRCREV_tn48m = "${AUTOREV}"
SRCREV_onl_tn48m = "${AUTOREV}"
SRCREV_infra_tn48m = "16ce9cd77f6639aac4813d698f9dd11f3ee47e7a"
SRCREV_bigcode_tn48m = "94091600faa76fac492b4be2ffab17cb9788d697"

ONL_BRANCH_tn48m = "main"


#TARGET_CFLAGS_ += "-Wno-error -Wno-error=restrict -Wno-error=format-overflow -Wno-error=cpp"

URI_ONL = "git://git@github.com/dentproject/dentOS.git;protocol=ssh"
...
TARGET_CFLAGS_tn48m += "-Wno-error -Wno-error=restrict -Wno-error=format-overflow -Wno-error=cpp -Wno-error=unused-result"
...
MODULE_tn48m = "arm64_delta_tn48m"
...
do_install_tn48m() {
    ...
    # .so file
    install -m 0755 packages/platforms/${ONIE_VENDOR}/${ONL_ARCH}/${ONL_MACHINE}/${ONL_MACHINE}/onlp/builds/lib/BUILD/${ONL_DEBIAN_SUITE}/${TOOLCHAIN}/bin/libonlp-${ONL_ARCH}-${ONL_VENDOR}-${ONL_MACHINE}.so ${D}/lib/platform-config/${ONL_ARCH}_${ONL_VENDOR}_${ONL_MACHINE}_r${ONIE_MACHINE_REV}/onl/lib

    # platform yml file
    install -m 0755 packages/platforms/${ONIE_VENDOR}/${ONL_ARCH}/${ONL_MACHINE}/${ONL_MACHINE}/platform-config/r${ONIE_MACHINE_REV}/src/lib/${ONL_ARCH}-${ONL_VENDOR}-${ONL_MACHINE}-r${ONIE_MACHINE_REV}.yml ${D}/lib/platform-config/${ONL_ARCH}_${ONL_VENDOR}_${ONL_MACHINE}_r${ONIE_MACHINE_REV}/onl
