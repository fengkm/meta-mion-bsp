...
SRC_URI = " \
           file://Makefile \
           file://x86-64-ufispace-s9700-53dx-lpc.c \
           file://COPYING \
          "
...
do_install() {
    ...
    install -m 0644 x86-64-ufispace-s9700-53dx-lpc.ko ${D}/lib/modules/${KERNEL_VERSION}/onl
}

#KERNEL_MODULE_AUTOLOAD += " x86-64-ufispace-s9700-53dx-lpc"
