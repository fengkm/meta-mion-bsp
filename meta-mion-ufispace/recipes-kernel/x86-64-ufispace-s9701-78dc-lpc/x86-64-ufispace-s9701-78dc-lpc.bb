...
SRC_URI = " \
           file://Makefile \
           file://x86-64-ufispace-s9701-78dc-lpc.c \
           file://COPYING \
          "
...
do_install() {
    ...
    install -m 0644 x86-64-ufispace-s9701-78dc-lpc.ko ${D}/lib/modules/${KERNEL_VERSION}/onl
}

#KERNEL_MODULE_AUTOLOAD += " x86-64-ufispace-s9701-78dc-lpc"
